...
- [REGISTROS (Records)](#registros)<br>
  ...
  - [Métodos para comparações de igualdade com base em valor como Equals(objeto), IEquatable<T>](#2---métodos-para-comparações-de-igualdade-com-base-em-valor-como-equalsobjeto-iequatablet)
