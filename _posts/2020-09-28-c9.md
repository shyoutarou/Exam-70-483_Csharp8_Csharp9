...
<br>1 [Copiar e clonar Membros (Copy and clone Members)](#1---copiar-e-clonar-membros)
     - [Expressões With](#expressões-with)
<br>2 [Métodos para comparações de igualdade com base em valor como Equals(objeto), IEquatable<T>](#2---métodos-para-comparações-de-igualdade-com-base-em-valor-como-equalsobjeto-iequatablet)
     - [sobrecargas Equals](#sobrecargas-equals)
     - [GetHashCode ()](#gethashcode-)
     - [operator == e operator !=](#operator--e-operator-)
     - [EqualityContract](#equalitycontract)
<br>3 [Override de GetHashCode()](#3---override-de-gethashcode)
<br>4 [PrintMembers e ToString()](#4---printmembers-e-tostring)
<br>5 [Método Construct/Deconstruct](#5---método-constructdeconstruct)
