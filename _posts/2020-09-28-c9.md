...
- [REGISTROS (Records)](#registros)
  1. [Copiar e clonar Membros (Copy and clone Members)](#1---copiar-e-clonar-membros)
  ...
  3. [3 - Override de GetHashCode()](#3---override-de-gethashcode)
  4. [4  -  PrintMembers e ToString()](#4---printmembers-e-tostring)
  5. [5 - Método Construct/Deconstruct](#5---método-constructdeconstruct)
